...
const ShoeStore = () => {
    let [shoe, setShoe] = useState(Shoe[0]);
    // console.log(shoe);
    ...
    return (
        <div>
                <h2 className='text-center font-bold text-3xl text-red-600'>Bài tập: hiện thông tin chi tiết của sản phẩm giày</h2>
            <DanhSachGiay updateShoe={updateShoe} listShoe={Shoe} title="Danh sách sản phẩm giày" />
            <ChiTietGiay shoeDetail={shoe} />
